...
//        	exit(0);
//        }
        // For founder rewards: 15% fee up to block 275300, then 1% afterwards.
std::vector<FounderRewardStructure> rewardStructures = { {275300, 15}, {INT_MAX, 1} };
...
consensus.nCollaterals = SmartnodeCollaterals(
  ...
  { {3090, 0}, {275300, 56}, {INT_MAX, 49} }  // smartnode reward percentage is 56% until block 275300, then 49%
);
